...
var Census = { // I put this stuff inside an object just because it looks good, lol
    ...
    question: function (obj) {
        if (!obj) return Census.end() // If the question is nonexistent, end it all!
        Census.current++
    ...
    switch: function (html) {
        ...
        Census.submit(Census.data) // Submit the data!
        ...
        Census.switch(html) // Destroy everything on the page, replacing it with the thank you message
        ...
        form.children[0].value = data.age
        //Put gender...
        form.children[1].value = data.gender
